...
def generate_market_intelligence(session_key: str) -> str:
    ...
    "Provide 5 real equities with positive percentage scores (e.g., 99%, 98%) and specific catalysts.\n\n"
    "Top 5 Low Sentiment Stocks\n"
    "| Ticker | Company Name | Sentiment Score | Primary Friction / Risk Factor |\n"
    "Provide 5 real equities or ETFs with negative percentage scores (e.g., -85%, -83%) and specific friction drivers.\n\n"
    "#### 3. ALPHA PROBABILITY & PRICE DELTA LEADERBOARD -- 1-YEAR HORIZON\n"
    "Provide four distinct tables with accurate current prices, 1-year targets, and percentage metrics:\n"
    ...
    "#### 7. STOCK SCORECARD\n"
    "Provide two comprehensive 15-column Markdown tables for active equities and tech leaders:\n"
